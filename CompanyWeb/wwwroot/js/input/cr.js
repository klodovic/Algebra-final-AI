...
(function (factory) {
    ...
    $.fn.fileinputLocales['cr'] = {
        ...
        msgUploadError: 'Greška pri slanju',
        ...
        dropZoneTitle: 'Dovucite datoteke ovdje&hellip;',
        dropZoneClickTitle: '<br>(or click to select {files})',
        fileActionSettings: {
            removeTitle: 'Uklonite datoteku',
            uploadTitle: 'Postavi datoteku',
            uploadRetryTitle: 'Pokušaj ponovo',
            downloadTitle: 'Download file',
            rotateTitle: 'Rotiraj u smjeru kazaljke na satu',
            zoomTitle: 'Detalji',
        ...
        previewZoomButtonTitles: {
            ...
            next: 'View next file',
            rotate: 'Rotiraj u smjeru kazaljke na satu',
            toggleheader: 'Sakrij zaglavlje',
            fullscreen: 'Prikaz preko cijelog zaslona',
            borderless: 'Prikaži u prozoru',
